...
public class ChatContoller {
	...
	@ResponseBody
	public String searchChatMember(@RequestParam(value="sv") String sv,HttpServletResponse response) throws IOException
	{
	...
	@ResponseBody
	public String insertChat(@RequestParam(value="my_id") String my_id, @RequestParam(value="your_id") String your_id,HttpServletResponse response) {
