...
}else
{
	...
	@ResponseBody
	public String deleteSoppingBasket(String deleteNo,HttpSession session,HttpServletResponse response) throws IOException
	{	response.setContentType("application/json; chatset=utf-8;");
		...
		ArrayList<ShowBasket> basketList = (ArrayList<ShowBasket>)shoppingBasketService.selectShoppingBasket(member_id);
