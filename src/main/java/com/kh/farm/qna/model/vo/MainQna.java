...
public class MainQna implements java.io.Serializable {
	...
	public MainQna(int main_qna_no, String member_id, String main_qna_title, String main_qna_contents, Date main_qna_date,
			String main_qna_answer, Date main_qna_answer_date) {
		super();
