	...
	<div id="wrap">
		...
		<div id="container">
			...
			<br>
				...
				<br>
				<div class="div">
				<form action="registerAuctionQnAModify.do" method="post">
						...
						<tbody>
							<tr class="tr" >
								...
								<td colspan="3" class="td2"><input type="text"
									name="auction_qna_title" class="input_text_box" value="${auctionqna.auction_qna_title }"> <br></td>
							</tr>
							...
							<tr>
								<td style="width: 100%;">
										...
										<textarea name="auction_qna_contents" id="ir1" rows="10" cols="100"
											style="width: 100%; height: 650px; display: none;">${auctionqna.auction_qna_contents }</textarea>
									</td>
							</tr>
						</tbody>
					</table>
					<input class="li4_input" type="button" value="뒤로가기">
						<input class="li4_input submit" type="submit" value="문의수정" onclick="submitContents();">
