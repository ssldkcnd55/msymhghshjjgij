...
<script src="/farm/resources/js/payment.js"></script>
      ...
      <!--  <div class="wrapper" align="center"> -->
         ...
         <div class="delivery" >
            ...
            <div class="delivery_choice_radio">
               <input type="radio" name="delivery" value="original_delivery" />기본배송지 &nbsp;
            ...
            <table class="table">
               <tr>
                  <td><input type="text" value="${loginUser.member_name }" name="user_name"readonly></td>
               </tr>
               <tr>
                  <td><input type="text" name="user_phone"value="${loginUser.member_tel }"> </td>
                  <td><input type="radio" name="relief_number" value="delivery_username_phone"/>안심번호서비스 사용</td>
               </tr>
               <tr>
                  <td colspan="2" class="table_colspan"><input type="text" name="useradd" value="${loginUser.member_addr }"></td>
               </tr>
               <tr>
                  <td colspan="2">
          ...
          <div class="checkout">
             <div>
                ...
                <span class="price" id="total_price">120,000</span>&nbsp;원
             </div>
             <hr>
             <table>
                <tr>
                   <th style="text-align:left;">총 상품 금액</th>
                   <td style="text-align:right;width:30%;" id="order_price">120,000원</td>
                </tr>
               <tr>
