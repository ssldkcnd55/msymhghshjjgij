      ...
      <!--  <div class="wrapper" align="center"> -->
         ...
         <div class="delivery" >
            ...
            <div class="delivery_choice_radio">
               <input type="radio" name="delivery" value="original_delivery" checked="checked" />기본배송지 &nbsp;
               <input type="radio" name="delivery" value="new_delivery" />신규배송지   &nbsp;
               <br><br>
               <hr>
            </div>                            
            ...
            <table class="infoTable">
               <tr>
                  ...
                  <td colspan="2"><input type="text" id="user_name" value="${loginUser.member_name }" name="user_name"readonly></td>
               </tr>
               <tr>
            ...
            <h5>안심번호 서비스 안내</h5>
										<p class="text">고객님의 개인정보보호를 위해 상품 주문 시 연락처<br>정보가 유출되지 않도록 1회성 임시번호를 발급해<br>드리는 서비스입니다.</p>
										<ul>
											<li>판매사와 택배사에 실제 고객님의 정보 대신 안심<br>번호가 제공되므로, 개인정보가 유출되는 것을<br>사전에 차단할 수 있습니다.</li>
											<li>발급된 안심번호는 일정기간 이후 해지되며, <br>해지 이후 취소/반품 등의 절차 진행 중에는 <br> 실제 연락처가 제공될 수 있습니다.</li>
											<li>발급된 안심번호는 결제완료 이후<br><strong>마이페이지 &gt; 구매목록 &gt; 구매상세내역</strong>에서 확인<br>하실 수 있으며, 배송완료 후 일정기간이 지나면<br>자동으로 해지됩니다</li>
											<li>안심번호 서비스는 SK텔링크에 위탁하여 <strong>무료</strong>로<br>제공해 드립니다.</li>
										</ul>
            </div></span></td>
               </tr>
               <tr>
...
<!--             신규배송지 -->
            <table class="newInfo" hidden="hidden">
            	<tr>
               		<td class="info_head">이름</td>
                  <td colspan="2"><input type="text" id="new_user_name" value="" name="user_name"></td>
               </tr>
               <tr>
               	  <td class="info_head">연락처</td>
            ...
            <h5>안심번호 서비스 안내</h5>
               ...
               <tr>
                  <td class="info_head">주소</td>
                  <td colspan="2" class="table_colspan"><button onclick="findAddr();" class="findAddr" >주소찾기</button><input type="text" id="new_user_addr" name="useradd" value="" readonly="readonly">
                  <input type="text" id="new_user_addr_detail" placeholder="상세주소"></td>
               </tr>
               <tr>
                  <td class="info_head">배송 메시지</td>
                  <td colspan="2">
          ...
          <div class="checkout">
             <div>
                ...
                <span class="price" id="total_price"></span>&nbsp;원
             </div>
             <hr>
             <table>
                <tr>
