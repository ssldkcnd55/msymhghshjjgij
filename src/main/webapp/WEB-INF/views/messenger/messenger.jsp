...
<body>
	<div class="messenger_frame">
		...
		<tr>
			<th class="messenger_back"><a href="javascript: back_chat_list()"><img src="/farm/resources/images/back_white.png"><!-- 채팅목록으로 이동 --></a></th>
		...
		<div class="msg_middle">
			...
			<div class="chat_list_table">
				...
				</a> <a href="javascript: move_msg_table();">
					<!-- 대화창으로 이동 A태그-->
					<table>
						<tr>
							<td class="list_profile" rowspan="2"><img
		...
		<div class="msg_middle_left_img"> 
				<table>
					<tr>
						 <th rowspan="2"><img src="/farm/resources/images/person_icon.png"></th> 
						<td>회원이름</td>
					</tr>
					<tr>
		...
		<!-- 메신져 하단 --><div class="msg_bottom">
		<table class="msg_bottom_table">
		<tr>
			<th><input class="msg_input" type="text" placeholder="메시지전송..." autofocus="autofocus"></th>
			<th ><a href="#"><!-- servlet method 실행 --><img  class="send_msg_icon" 
					 src="/farm/resources/images/send_msg_icon_3.png"></a></th>
		</tr>
	</table>
	</div>
	</div>
