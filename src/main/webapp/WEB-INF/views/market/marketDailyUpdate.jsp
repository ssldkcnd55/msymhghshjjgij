	...
	<div id="wrap">
		...
		<div id="container">
			<div class="inner-wrap">
				...
				<div class="div">
				<form action="marketDailyUpdate.do" method="post">
						...
						<tbody>
							<tr class="tr">
								...
								<td colspan="3" class="td2"><input type="text"
									name="daily_title" value="${daily.daily_title}" class="input_text_box"> <br></td>
							</tr>
						...
						<tbody>
							<tr>
								<td style="width: 100%;">
										...
										<textarea name="daily_contents" id="ir1" rows="10" cols="100"
											style="width: 100%; height: 250px; display: none;">${daily.daily_contents}</textarea>
									</td>
							</tr>
						</tbody>
					</table>
					<input class="li4_input" type="button" value="뒤로가기">
						...
						<input type="hidden" name="daily_no" value="${daily.daily_no }">
				</form>
				</div>
			</div>
		</div>
