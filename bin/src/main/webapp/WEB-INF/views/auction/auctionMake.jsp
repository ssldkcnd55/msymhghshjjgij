...
<body>
						...
						<tbody>
							<tr class="tr1">
								...
								<td class="td2" colspan="3"><input type="text"
									name="product_name"> <input type="submit"
									name="product_name" value="카테고리검색" class="input_text_box">
									<br></td>
							</tr>
							<tr class="tr1">
								<td class="td1">
							...
							<tr class="tr1">
								...
								<td colspan="3" class="td2"><input type="text"
									name="product_name"> <input type="checkbox"
									name="product_name" class="input_checkbox"
	...
	<script type="text/javascript">
		...
		nhn.husky.EZCreator.createInIFrame({
			oAppRef : oEditors,
			elPlaceHolder : "ir1",
			sSkinURI : "moveSmartEditor2Skin.do",
			htParams : {
